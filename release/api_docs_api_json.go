...
*/
func (a *DocsApiJsonAPIService) DocsApiJsonGet1(ctx context.Context, pulpDomain string) DocsApiJsonAPIDocsApiJsonGet1Request {
	return DocsApiJsonAPIDocsApiJsonGet1Request{
		ApiService: a,
		ctx: ctx,
...
func (a *DocsApiJsonAPIService) DocsApiJsonGet1Execute(r DocsApiJsonAPIDocsApiJsonGet1Request) (map[string]interface{}, *http.Response, error) {
	...
	localVarPath := localBasePath + "/pulp/{pulp_domain}/api/v3/docs/api.json"
